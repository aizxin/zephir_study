...
class Pdo implements ResultInterface
{
	...
	/**
	 * Vof\Db\Result\Pdo constructor
	 *
	 * @param \Vof\Db\AdapterInterface connection
	 ...
	 * This method is affected by the active fetch flag set using Vof\Db\Result\Pdo::setFetchMode
	 *
	 *<code>
	 * $result = $connection->query("SELECT * FROM robots ORDER BY name");
	 *
	...
	/**
	 * Changes the fetching mode affecting Vof\Db\Result\Pdo::fetch()
	 *
	 *<code>
