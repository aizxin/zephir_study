...
namespace Vof\Db\Adapter;

use Vof\Db\Adapter;
use Vof\Db\Exception;
use Vof\Db\Column;
use Vof\Db\ResultInterface;
use Vof\Events\ManagerInterface;
use Vof\Db\Result\Pdo as ResultPdo;

/**
 * Vof\Db\Adapter\Pdo
 *
 * Vof\Db\Adapter\Pdo is the Vof\Db that internally uses PDO to connect to a database
 *
 * <code>
...
abstract class Pdo extends Adapter
{
	...
	/**
	 * Constructor for Vof\Db\Adapter\Pdo
	 */
