...
namespace Vof\Db\Adapter\Pdo;

use Vof\Db\Column;
use Vof\Db\RawValue;
use Vof\Db\Adapter\Pdo as PdoAdapter;
use Vof\Db\Exception;

/**
 * Vof\Db\Adapter\Pdo\Postgresql
 *
 * Specific functions for the Postgresql database system
 *
 * <code>
 * use Vof\Db\Adapter\Pdo\Postgresql;
 *
 * $config = [
 *     "host"     => "localhost",
 *     "dbname"   => "blog",
...
class Postgresql extends PdoAdapter
{
	...
	/**
	 * This method is automatically called in Vof\Db\Adapter\Pdo constructor.
	...
	/**
	 * Returns an array of Vof\Db\Column objects describing a table
	 *
	 * <code>
	 * print_r(
	...
	public function describeColumns(string table, string schema = null) -> <Column[]>
	{
		 ...
		 */
		for field in this->fetchAll(this->_dialect->describeColumns(table, schema), \Vof\Db::FETCH_NUM) {
			...
			/**
			 * By checking every column type we convert it to a Vof\Db\Column
			 */
			...
			/**
			 * Every route is stored as a Vof\Db\Column
			 */
	 ...
	 */
	public function modifyColumn(string! tableName, string! schemaName, <\Vof\Db\ColumnInterface> column, <\Vof\Db\ColumnInterface> currentColumn = null) -> boolean
	{
