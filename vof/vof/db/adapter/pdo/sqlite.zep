...
use Vof\Db\RawValue;
use Vof\Db\Reference;
use Vof\Db\ReferenceInterface;
use Vof\Db\Index;
use Vof\Db\IndexInterface;
use Vof\Db\Adapter\Pdo as PdoAdapter;

/**
 * Vof\Db\Adapter\Pdo\Sqlite
 *
 * Specific functions for the Sqlite database system
 *
 * <code>
 * use Vof\Db\Adapter\Pdo\Sqlite;
 *
...
class Sqlite extends PdoAdapter
{
	 ...
	 * @param	string table
	 * @param	string schema
	 * @return	Vof\Db\ReferenceInterface[]
	 */
