...
use Vof\Db\Profiler\Item;

/**
 * Vof\Db\Profiler
 *
 * Instances of Vof\Db can generate execution profiles
 * on SQL statements sent to the relational database. Profiled
 * information includes execution time in milliseconds.
 * This helps you to identify bottlenecks in your applications.
 *
 *<code>
 * $profiler = new \Vof\Db\Profiler();
 *
...
class Profiler
{
	...
	/**
	 * All the Vof\Db\Profiler\Item in the active profile
	 *
	 * @var \Vof\Db\Profiler\Item[]
	 */
	protected _allProfiles;

	/**
	 * Active Vof\Db\Profiler\Item
	 *
	 * @var Vof\Db\Profiler\Item
	 */
