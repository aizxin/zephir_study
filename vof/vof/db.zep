 ...
 * Vof\Db
 *
 * Vof\Db and its related classes provide a simple SQL database interface for Phalcon Framework.
 * The Vof\Db is the basic class you use to connect your PHP application to an RDBMS.
 * There is a different adapter class for each brand of RDBMS.
 *
 * This component is intended to lower level database operations. If you want to interact with databases using
 * higher level of abstraction use Vof\Mvc\Model.
 *
 * Vof\Db is an abstract class. You only can use it with a database adapter like Vof\Db\Adapter\Pdo
 *
 *<code>
 * use Vof\Db;
 * use Vof\Db\Exception;
 * use Vof\Db\Adapter\Pdo\Mysql as MysqlConnection;
 *
 * try {
