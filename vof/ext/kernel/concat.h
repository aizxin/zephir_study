...
#define ZEPHIR_CONCAT_SVVSV(result, op1, op2, op3, op4, op5) \
	 zephir_concat_svvsv(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, 0);
#define ZEPHIR_SCONCAT_SVVSV(result, op1, op2, op3, op4, op5) \
	 zephir_concat_svvsv(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, 1);

#define ZEPHIR_CONCAT_SVVSVS(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_svvsvs(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, 0);
#define ZEPHIR_SCONCAT_SVVSVS(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_svvsvs(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, 1);
...
void zephir_concat_svvsv(zval *result, const char *op1, zend_uint op1_len, zval *op2, zval *op3, const char *op4, zend_uint op4_len, zval *op5, int self_var);
void zephir_concat_svvsvs(zval *result, const char *op1, zend_uint op1_len, zval *op2, zval *op3, const char *op4, zend_uint op4_len, zval *op5, const char *op6, zend_uint op6_len, int self_var);
