...
ZEPHIR_INIT_CLASS(Vof_Session_Adapter) {
	...
	ZEPHIR_REGISTER_CLASS(Vof\\Session, Adapter, vof, session_adapter, vof_session_adapter_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_declare_property_null(vof_session_adapter_ce, SL("_uniqueId"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_bool(vof_session_adapter_ce, SL("_started"), 0, ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(vof_session_adapter_ce, SL("_options"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zephir_declare_class_constant_long(vof_session_adapter_ce, SL("SESSION_ACTIVE"), 2);

	zephir_declare_class_constant_long(vof_session_adapter_ce, SL("SESSION_NONE"), 1);

	zephir_declare_class_constant_long(vof_session_adapter_ce, SL("SESSION_DISABLED"), 0);

	zend_class_implements(vof_session_adapter_ce TSRMLS_CC, 1, vof_session_adapterinterface_ce);
	return SUCCESS;
...
PHP_METHOD(Vof_Session_Adapter, start) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "headers_sent", NULL, 2);
	zephir_check_call_status();
...
PHP_METHOD(Vof_Session_Adapter, setName) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_name", NULL, 4, &name);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Vof_Session_Adapter, getName) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_name", NULL, 4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Vof_Session_Adapter, regenerateId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_regenerate_id", NULL, 5, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Vof_Session_Adapter, getId) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_id", NULL, 6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Vof_Session_Adapter, setId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_id", NULL, 6, &id);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Vof_Session_Adapter, destroy) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_destroy", NULL, 7);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Vof_Session_Adapter, status) {
	...
	ZEPHIR_CALL_FUNCTION(&status, "session_status", NULL, 8);
	zephir_check_call_status();
	do {
...
PHP_METHOD(Vof_Session_Adapter, __destruct) {
	...
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_FUNCTION(NULL, "session_write_close", NULL, 9);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, SL("_started"), &__$true);
		} else {
...
PHP_METHOD(Vof_Session_Adapter, removeSessionData) {
	...
	if (!(ZEPHIR_IS_EMPTY(&uniqueId))) {
		...
		zephir_is_iterable(_SESSION, 1, "vof/session/adapter.zep", 364);
