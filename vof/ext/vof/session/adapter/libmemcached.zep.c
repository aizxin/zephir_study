...
ZEPHIR_INIT_CLASS(Vof_Session_Adapter_Libmemcached) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Vof\\Session\\Adapter, Libmemcached, vof, session_adapter_libmemcached, vof_session_adapter_ce, vof_session_adapter_libmemcached_method_entry, 0);

	zend_declare_property_null(vof_session_adapter_libmemcached_ce, SL("_libmemcached"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(vof_session_adapter_libmemcached_ce, SL("_lifetime"), 8600, ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Vof_Session_Adapter_Libmemcached, __construct) {
	...
	if (!(zephir_array_isset_string_fetch(&servers, &options, SL("servers"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(vof_session_exception_ce, "No servers given in options", "vof/session/adapter/libmemcached.zep", 76);
		return;
	}
	...
	ZEPHIR_CALL_FUNCTION(&_1, "min", NULL, 76, &lifetime, &_0);
	...
	ZEPHIR_INIT_VAR(&_2);
	object_init_ex(&_2, vof_cache_backend_libmemcached_ce);
	ZEPHIR_INIT_VAR(&_3);
	object_init_ex(&_3, vof_cache_frontend_data_ce);
	ZEPHIR_INIT_VAR(&_4);
	...
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 77, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 78, &_3, &_6);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_set_save_handler", NULL, 79, &_7, &_9, &_10, &_11, &_12, &_13);
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, vof_session_adapter_libmemcached_ce, getThis(), "__construct", &_14, 0, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
