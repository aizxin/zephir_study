...
ZEPHIR_INIT_CLASS(Vof_Session_Adapter_Memcache) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Vof\\Session\\Adapter, Memcache, vof, session_adapter_memcache, vof_session_adapter_ce, vof_session_adapter_memcache_method_entry, 0);

	zend_declare_property_null(vof_session_adapter_memcache_ce, SL("_memcache"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(vof_session_adapter_memcache_ce, SL("_lifetime"), 8600, ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Vof_Session_Adapter_Memcache, __construct) {
	...
	ZEPHIR_INIT_VAR(&_3);
	object_init_ex(&_3, vof_cache_backend_memcache_ce);
	ZEPHIR_INIT_VAR(&_4);
	object_init_ex(&_4, vof_cache_frontend_data_ce);
	ZEPHIR_INIT_VAR(&_5);
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 77, &_5);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 80, &_4, &options);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, vof_session_adapter_memcache_ce, getThis(), "__construct", &_14, 0, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
